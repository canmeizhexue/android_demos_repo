...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener {
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture texture, int width, int height) {
            //这个是TextureView的大小，
            Log.d("zyp","onSurfaceTextureAvailable------width---height--"+width+"-------"+height);
            openCamera(width, height);
        }

        @Override
        public void onSurfaceTextureSizeChanged(SurfaceTexture texture, int width, int height) {
            Log.d("zyp","onSurfaceTextureSizeChanged----"+width+"-----"+height);
...
//            Log.d("zyp","onCaptureCompleted");
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            //关掉屏幕再打开，不会走onSurfaceTextureAvailable回调？
            //TextureView可用的时候，直接打开相机，
    ...
    private void createCameraPreviewSession() {
        try {
            //取出TextureView对应的SurfaceTexture,,,,
