...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener {
    ...
    private boolean hasSetupMediaRecorder=false;
    /**
     * MediaRecorder
     */
    ...
    private void setUpMediaRecorder() throws IOException {
        final Activity activity = getActivity();
        if (null == activity || hasSetupMediaRecorder) {
            return;
        }
        hasSetupMediaRecorder = true;
        //设置音频来源，麦克风，
        ...
        Log.d("zyp","视频保存路径  "+getVideoFile(activity).getAbsolutePath());
        //视频比率
    ...
    private void stopRecordingVideo() {
        ...
        //解决方法来自，https://stackoverflow.com/questions/27907090/android-camera-2-api
        try {
