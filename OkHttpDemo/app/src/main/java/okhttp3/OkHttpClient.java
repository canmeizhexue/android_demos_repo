 ...
 *
 *
 * 应该共享一个okHttpClient,这样可以共用连接池和线程池，
 ...
 *
 *
 * 通过newBuilder方法可以创建一个和之前okHttpClient共享连接池和线程池的okHttpClient,,一般不用，
...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
  ...
  public static final class Builder {
    ...
    public Builder() {
      ...
      //默认情况下interceptors和networkInterceptors都是空的，
      ...
      connectionPool = new ConnectionPool();//构建连接池，
      dns = Dns.SYSTEM;
